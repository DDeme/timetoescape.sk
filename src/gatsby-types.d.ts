...
type CustomerImagesQueryVariables = Exact<{ [key: string]: never; }>;


type CustomerImagesQuery = { readonly allFiles: { readonly edges: ReadonlyArray<{ readonly node: { readonly name: string, readonly id: string, readonly relativePath: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } }> } };

type GalleryImagesQueryVariables = Exact<{ [key: string]: never; }>;


type GalleryImagesQuery = { readonly allFiles: { readonly edges: ReadonlyArray<{ readonly node: { readonly name: string, readonly id: string, readonly relativePath: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } }> } };
...
type MyQueryQuery = { readonly allFiles: { readonly edges: ReadonlyArray<{ readonly node: { readonly name: string, readonly id: string, readonly relativePath: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } }> } };
