...
const preconnect = ['https://connect.facebook.net', 'https://www.facebook.com', 'https://static.xx.fbcdn.net']
...
export const Seo = ({
  ...
  return (
    <>
      ...
      <link rel="icon" type="image/png" href={withPrefix('/favicon/favicon.svg')} />
      {children}
    </>
  )
}
